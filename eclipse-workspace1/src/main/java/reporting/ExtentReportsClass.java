...
/*	@Test
	public void FirstTest(){
		...
		//Starting test
		logger = extent.createTest("FirstTest");
		Assert.assertTrue(true);
		//To generate the log when the test case is passed
		logger.log(Status.FAIL, "Test Case Passed is First Test");
	}
	...
	public void failTest(){
		...
		try {
			logger.log(Status.FAIL, "Snapshot below: " + logger.addScreenCaptureFromPath(System.getProperty("user.dir") +"/test-output/STMExtentReport.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
